      ...
      >
        ...
        <v-container fluid style="height:70vh" class="py-0">
          <v-row class="h-100">
            ...
            >
               <div v-if="showNextPrev" class="d-flex my-4">
               <h4 style="color:grey; font-size: 12px">ACTIVITY</h4>
                <span class="flex-grow-1" />
                <x-icon style="color: dodgerblue;" small outlined @click="test">
                  mdi-rss
                </x-icon>
                  <h4 style="color:dodgerblue; font-size: 10px"> Watching</h4>
              </div>
